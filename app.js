  ...
  "intents": [
    {
      ...
      "chips": ["Work History", "Explore Projects", "Certifications", "View Skills", "About Sayantan"]
    },
    {
      "id": "thanks",
      "keywords": ["thanks", "thank you", "thank u", "thx", "appreciate it", "thank", "thankyou", "grateful", "much obliged", "thank you so much", "thanks a lot"],
      "responses": [
        "You're very welcome! I'm glad I could help. Let me know if you want to explore my **skills**, **projects**, **experience**, or **certifications**!",
    ...
    },
    {
      ...
      "chips": ["Start Over", "Work History", "Explore Projects", "Get Contact Details"]
    },
    {
      "id": "about",
    ...
    },
    {
      ...
      "chips": ["AI Workflow", "Skill Ratings", "Explore Projects", "Work History"]
    },
    {
      "id": "skill_ratings",
      ...
      "chips": ["Work History", "Explore Projects", "Certifications", "Get Contact Details"]
    },
    {
      "id": "projects",
    ...
    },
    {
      ...
      "chips": ["Explore Projects", "Work History", "Certifications", "Get Contact Details"]
    },
    {
      "id": "asparz",
    ...
    },
    {
      ...
      "chips": ["Explore Projects", "Work History", "View Skills", "Get Contact Details"]
    },
    {
    ...
    },
    {
      ...
      "chips": ["Explore Projects", "Certifications", "View Skills", "Education Background"]
    },
    {
      "id": "education",
    ...
    },
    {
      ...
      "chips": ["Work History", "Explore Projects", "Certifications", "View Skills"]
    },
    {
      "id": "personal",
    ...
    },
    {
      ...
      "chips": ["Explore Projects", "Work History", "Certifications", "View Skills"]
    },
    {
      "id": "leadership",
    ...
    },
    {
      ...
      "chips": ["AI Workflow", "Work History", "Explore Projects", "View Skills"]
    },
    {
      "id": "ai_workflow",
      ...
      "chips": ["Why Chat", "View Skills", "Explore Projects", "Work History"]
    },
    {
      "id": "deflect_jokes",
      "keywords": ["joke", "jokes", "funny", "laugh", "tell me a joke"],
      "responses": [
        "I'd love to share a joke, but my directory is currently optimized strictly for design portfolio reviews. Let's keep the focus on my product strategy! Feel free to explore my work, experience, or certifications below:"
      ],
      "chips": ["Work History", "Explore Projects", "Certifications", "View Skills"]
    },
    {
    ...
    },
    {
      ...
      "responses": [
        "Hmm, it seems like your last message is incomplete or brief. Feel free to explore my structured portfolio guide by choosing any of the core topics below:"
      ],
      "chips": ["Work History", "Explore Projects", "Certifications", "View Skills"]
    },
    {
    ...
    },
    {
      ...
      "chips": ["AI Workflow", "View Skills", "Explore Projects", "Work History"]
    },
    {
      "id": "portfolio_links",
    ...
    },
    {
      ...
      "chips": ["About Sayantan", "AI Workflow", "Explore Projects", "Work History"]
    },
    {
      "id": "skills_figma",
    ...
    },
    {
      ...
      "chips": ["View Skills", "AI Workflow", "Certifications", "Get Contact Details"]
    },
    {
      "id": "exp_tenxengage",
...
function streamBotMessage(fullText, chips) {
  ...
  const streamInterval = setInterval(() => {
    if (currentWordIndex < words.length) {
      ...
      // Render Chips Directly Inside Chat Bubble
      renderBubbleChips(chips, messageDiv, footerDiv);
...
/**
 * Render quick action chips inside the bot message bubble.
 */
function renderBubbleChips(chips, messageDiv, footerDiv) {
  if (!chips || chips.length === 0) return;

  const chipsWrapper = document.createElement('div');
  chipsWrapper.className = 'bubble-chips-wrapper';
  ...
  if (footerDiv && footerDiv.parentNode === messageDiv) {
    messageDiv.insertBefore(chipsWrapper, footerDiv);
  } else {
    messageDiv.appendChild(chipsWrapper);
  }
}
